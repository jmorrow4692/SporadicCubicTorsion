//////////////////////////////////////////////////////////////////////////////////////////
// This is a complete determination of the cubic points on X1(33)
//////////////////////////////////////////////////////////////////////////////////////////
...
/****************************************************************************** 
 ...
 We map to X0(33), which is  a genus 3 hyperelliptic curve. Since the rational
 points of X0(33) are cusps, any non cuspidal cubic point of X1(33) maps 
 to a cubic point of X0(33). The map X0(33)^(3) --> J0(33) is not injective, but
 is still injective on rational cubic points. 

 The rational torsion of J0(33) is Z/10Z x Z/10Z. 
 Computing the preimage of Abel--Jabobi (and a small argument to verify that 
 the cubic points on X0(33) do not lift to X1(33) succeeds.
******************************************************************************/
...
//  for p in [q : q in PrimesUpTo(40) | not q in PrimeDivisors(2*N) ] do
  ...
  "The rational torsion subgroup is a subgroup of", torsBound(torsData); ; // [10,10]
  ...
  ////////////////////////////////////////////////////////////////////////
     ...
     D1 :=   (Divisor(mInv(pts[1])) - Divisor(mInv(pts[2])));  
       order(D1); // 10
     D2 := 3*(Divisor(mInv(pts[1])) - Divisor(mInv(pts[3])));
       order(D2); // 10
  ...
  // there is a 33-torsion point on a twist of a corresponding curve.
  ////////////////////////////////////////////////////////////////////////        
