...
/****************************************************************************** 
 Here is a summary of the argument.
  ...
  - An additional local argument (see the paper) proves that the torsion is [2, 2, 120]
...
//  pts4 := divisorSearch(Xsm,4,2);   // 21 seconds
  ...
  // Verify that the reduction of J(Q(i))_tors contributes the extra factor of 2
  globalQi, mGlobalQi := sub<pic | [(Inverse(mPic))(D) : D in divsp join {@extraTorsion@}]>;
    "The known Q(i)-rational divisors generate a subgroup isomorphic to", Invariants(globalQi); // [ 2, 2, 2 120 ]      
